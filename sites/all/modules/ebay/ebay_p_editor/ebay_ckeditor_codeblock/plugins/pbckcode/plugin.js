CKEDITOR.plugins.add('pbckcode', {
    ...
    init: function(editor) {
        ...
        editor.addCommand('pbckcodeRemove', {
        	exec : function(editor) {
        		var selection = editor.getSelection();
				// get the entire element
      			var element = selection.getStartElement();
      			if (element) {
	        		var codeBlock = element.getAscendant('pre', true);
	                if(codeBlock) {
	                    codeBlock.remove();
	                }
				}
        ...
        if (editor.contextMenu) {
            ...
            editor.addMenuItem('pbckcodeItemRemove', {
                label   : editor.lang.pbckcode.removeCode,
                command : 'pbckcodeRemove',
                group   : 'pbckcodeGroup'
            });
            ...
            editor.contextMenu.addListener( function(element) {
                if(element.getAscendant('pre', true)) {
                    return { pbckcodeItemRemove: CKEDITOR.TRISTATE_OFF };
                }
            });
        }
