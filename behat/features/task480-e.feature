Feature: PW-480 e Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/howto"
    Then I should see "Access Denied"
    Then I click "Logout"

  @javascript @insulated @480
  Scenario: PW staff should be able to create content How-To and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/howto"
    When I fill in "Headline" with "howtotest1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/howtotest1/how-to/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/howto"
    When I fill in "Headline" with "howtotest2"
    Then I fill article values
    When I press button "Save as draft"
    # When I press button "Save as draft"
    Then I should be redirected to article page "/news/howtotest2/how-to/" + current day
    Then I click "Logout"
    And go to "/news/howtotest2/how-to/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/howtotest2/how-to/" + current day
    And I click "Edit"
    ...
    And go to "/news/howtotest1/how-to/" + current day
...
#  @javascript @insulated @480
#  Scenario: PW staff should create content How-To but leave published date empty



  @javascript @insulated @480
  Scenario: PW staff should create content How-To but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/howto"
    When I fill in "Headline" with "howtotest3"
    Then I fill article values
    When I press button "Publish"
    # When I press button "Publish"
    Then I should be redirected to article page "/news/howtotest3/how-to/" + current day
    Then I click "Logout"
    And go to "/news/howtotest3/how-to/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in how-to edit form
