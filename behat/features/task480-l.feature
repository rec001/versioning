Feature: PW-480 l Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/newsletter"
    Then I should see "Access Denied"
    Then I click "Logout"


  @javascript @insulated @480
  Scenario: PW staff should be able to create content Newsletter and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/newsletter"
    When I fill in "Headline" with "newslettertest1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/newslettertest1/newsletter/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/newsletter"
    When I fill in "Headline" with "newslettertest2"
    Then I fill article values
    When I press button "Save as draft"
    # When I press button "Save as draft"
    Then I should be redirected to article page "/news/newslettertest2/newsletter/" + current day
    Then I click "Logout"
    And go to "/news/newslettertest2/newsletter/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/newslettertest2/newsletter/" + current day
    And I click "Edit"
    ...
    And go to "/news/newslettertest1/newsletter/" + current day
...
# @javascript @insulated @480
# Scenario: PW staff should create content Newsletter but leave published date empty



  @javascript @insulated @480
  Scenario: PW staff should create content Newsletter but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/newsletter"
    When I fill in "Headline" with "newslettertest3"
    Then I fill article values
    When I press button "Publish"
    # When I press button "Publish"
    Then I should be redirected to article page "/news/newslettertest3/newsletter/" + current day
    Then I click "Logout"
    And go to "/news/newslettertest3/newsletter/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in newsletter edit form
