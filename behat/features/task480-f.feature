Feature: PW-480 f Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/advertorial"
    Then I should see "Access Denied"
    Then I click "Logout"

  @javascript @insulated @480
  Scenario: PW staff should be able to create content Advertorial and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/advertorial"
    When I fill in "Headline" with "advertorialtest1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/advertorialtest1/advertorial/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/advertorial"
    When I fill in "Headline" with "advertorialtest2"
    Then I fill article values
    When I press button "Save as draft"
    # When I press button "Save as draft"
    Then I should be redirected to article page "/news/advertorialtest2/advertorial/" + current day
    Then I click "Logout"
    And go to "/news/advertorialtest2/advertorial/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/advertorialtest2/advertorial/" + current day
    And I click "Edit"
    ...
    And go to "/news/advertorialtest1/advertorial/" + current day
...
# @javascript @insulated @480
# Scenario: PW staff should create content Advertorial but leave published date empty



  @javascript @insulated @480
  Scenario: PW staff should create content Advertorial but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/advertorial"
    When I fill in "Headline" with "advertorialtest3"
    Then I fill article values
    When I press button "Publish"
    # When I press button "Publish"
    Then I should be redirected to article page "/news/advertorialtest3/advertorial/" + current day
    Then I click "Logout"
    And go to "/news/advertorialtest3/advertorial/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in advertorial edit form
