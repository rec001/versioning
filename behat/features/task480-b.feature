Feature: PW-480 b Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/brief"
    Then I should see "Access Denied"
    Then I click "Logout"

  @javascript @insulated @480
  Scenario: PW staff should be able to create content Brief and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/brief"
    When I fill in "Headline" with "brieftest1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/brieftest1/brief/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/brief"
    When I fill in "Headline" with "brieftest2"
    Then I fill article values
    When I press button "Save as draft"
    # Then I press button "Save as draft"
    Then I should be redirected to article page "/news/brieftest2/brief/" + current day
    Then I click "Logout"
    And go to "/news/brieftest2/brief/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/brieftest2/brief/" + current day
    And I click "Edit"
    ...
    And go to "/news/brieftest1/brief/" + current day
  ...
  #@javascript @insulated @480
  #Scenario: PW staff should create content Brief but leave published date empty and press "save as draft"



  @javascript @insulated @480
  Scenario: PW staff should create content Brief but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/brief"
    When I fill in "Headline" with "brieftest3"
    Then I fill article values
    When I press button "Publish"
    # When I press button "Publish"
    Then I should be redirected to article page "/news/brieftest3/brief/" + current day
    Then I click "Logout"
    And go to "/news/brieftest3/brief/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in brief edit form
