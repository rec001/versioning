Feature: PW-480 c Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/analysis"
    Then I should see "Access Denied"
    Then I click "Logout"


  @javascript @insulated @480
  Scenario: PW staff should be able to create content Analysis and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/analysis"
    When I fill in "Headline" with "analysis1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/analysis1/analysis/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/analysis"
    When I fill in "Headline" with "analysis2"
    Then I fill article values
    When I press button "Save as draft"
    # Then I press button "Save as draft"
    Then I should be redirected to article page "/news/analysis2/analysis/" + current day
    Then I click "Logout"
    And go to "/news/analysis2/analysis/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/analysis2/analysis/" + current day
    And I click "Edit"
    ...
    And go to "/news/analysis1/analysis/" + current day
...
#  @javascript @insulated @480
#  Scenario: PW staff should create content Analysis but leave published date empty



  @javascript @insulated @480
  Scenario: PW staff should create content Analysis but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/analysis"
    When I fill in "Headline" with "analysis3"
    Then I fill article values
    When I press button "Publish"
    # When I press button "Publish"
    Then I should be redirected to article page "/news/analysis3/analysis/" + current day
    Then I click "Logout"
    And go to "/news/analysis3/analysis/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in analysis edit form
