Feature: PW-480 i Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/press-release"
    Then I should see "Access Denied"
    Then I click "Logout"


  @javascript @insulated @480
  Scenario: PW staff should be able to create content Press Release and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/press-release"
    When I fill in "Headline" with "pressreleasetest1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/pressreleasetest1/press-release/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/press-release"
    When I fill in "Headline" with "pressreleasetest2"
    Then I fill article values
    When I press button "Save as draft"
    # When I press button "Save as draft"
    Then I should be redirected to article page "/news/pressreleasetest2/press-release/" + current day
    Then I click "Logout"
    And go to "/news/pressreleasetest2/press-release/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/pressreleasetest2/press-release/" + current day
    And I click "Edit"
    ...
    And go to "/news/pressreleasetest1/press-release/" + current day
...
# @javascript @insulated @480
# Scenario: PW staff should create content Press Release but leave published date empty



  @javascript @insulated @480
  Scenario: PW staff should create content Press Release but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/press-release"
    When I fill in "Headline" with "pressreleasetest3"
    Then I fill article values
    When I press button "Publish"
    # When I press button "Publish"
    Then I should be redirected to article page "/news/pressreleasetest3/press-release/" + current day
    Then I click "Logout"
    And go to "/news/pressreleasetest3/press-release/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in press release edit form
