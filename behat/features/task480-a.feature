Feature: PW-480 a Article Entry Form and Fields
  ...
  @javascript @insulated @480
  Scenario: PW staff should be able to create content News and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/news"
    When I fill in "Headline" with "newstest1"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/newstest1/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/news"
    When I fill in "Headline" with "newstest2"
    Then I fill article values
    When I press button "Save as draft"
    #When I press button "Save as draft" you don't need this
    Then I should be redirected to article page "/news/newstest2/" + current day
    Then I click "Logout"
    And go to "/news/newstest2/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/newstest2/" + current day
    And I click "Edit"
    ...
    And go to "/news/newstest1/" + current day
...
#  Scenario: PW staff should create content News but leave published date empty and press "save as draft"



  @javascript @insulated @480
  Scenario: PW staff should create content News but leave published date empty but press publish
  button and the content should get published
    ...
    Then I click "Logout"
    And go to "/news/newstest3/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in news edit form
  ...
  Scenario: The Publish on date should be per the time zone selected in drupal.
    ...
    #When I select Scheduling option I should check the time and timezone and see if the value is correct.
    #When I change the time zone to "America/Denver"
    #And I then go to add a new api
    #When I select Scheduling option I should check the time and timezone and see if the value is correct.
