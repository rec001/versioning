Feature: PW-480 n Article Entry Form and Fields
  ...
  Scenario: Registered User should not create articles
    ...
    And I am on "node/add/elsewhere-on-the-web"
    Then I should see "Access Denied"
    Then I click "Logout"


  @javascript @insulated @480
  Scenario: PW staff should be able to create content Elsewhere on The Web and schedule a publish date
    Then I log on as "pwstaff1"
    And I am on "node/add/elsewhere-on-the-web"
    When I fill in "Headline" with "elsewheretest1"
    ...
    When I fill in "Headline on Actual Article" with "test headline"
    When I fill in "URL To Article" with "http://www.google.com"
    When I fill in "Name of Host Site" with "test site"
    When I fill in "URL To Home Page of Host Site" with "http://www.yahoo.com"
    When I fill in "Author's Name" with "Author vishal"
    ...
    Then I press button "Save as draft"
    Then I should be redirected to article page "/news/elsewheretest1/elsewhere-web/" + current day
    Then I click "Logout"

    Then I log on as "pwstaff1"
    And I am on "node/add/elsewhere-on-the-web"
    When I fill in "Headline" with "elsewheretest2"
    Then I fill article values
    When I fill in "Headline on Actual Article" with "test headline"
    When I fill in "URL To Article" with "http://www.google.com"
    When I fill in "Name of Host Site" with "test site"
    ...
    # When I press button "Save as draft"
    Then I should be redirected to article page "/news/elsewheretest2/elsewhere-web/" + current day
    Then I click "Logout"
    And go to "/news/elsewheretest2/elsewhere-web/" + current day
    Then I should see "Access Denied"
    Then I log on as "pwstaff1"
    And go to "/news/elsewheretest2/elsewhere-web/" + current day
    And I click "Edit"
    ...
    And go to "/news/elsewheretest1/elsewhere-web/" + current day
...
# @javascript @insulated @480
# Scenario: PW staff should create content Elsewhere on The Web but leave published date empty



  @javascript @insulated @480
  Scenario: PW staff should create content Elsewhere on The Web but leave published date empty but press publish
  button and the content should get published
    Then I log on as "pwstaff1"
    And I am on "node/add/elsewhere-on-the-web"
    When I fill in "Headline" with "elsewheretest3"
    Then I fill article values
    When I fill in "Headline on Actual Article" with "test headline"
    When I fill in "URL To Article" with "http://www.google.com"
    When I fill in "Name of Host Site" with "test site"
    ...
    # When I press button "Publish"
    Then I should be redirected to article page "/news/elsewheretest3/elsewhere-web/" + current day
    Then I click "Logout"
    And go to "/news/elsewheretest3/elsewhere-web/" + current day
  ...
  @javascript @insulated @480
  Scenario: Manager should be able to see all fields in else where on the web edit form
